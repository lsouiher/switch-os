...
import { normalizeKey, matchShortcut, defaultMacShortcuts } from '@/simulation/keyboardHandler';
...
export default function Desktop() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      const shortcut = matchShortcut(pressed, defaultMacShortcuts);
      if (shortcut) {
        e.preventDefault();
        recordAction({
          type: 'shortcut',
  ...
  }, [addPressedKey, removePressedKey, clearPressedKeys, recordAction, toggleSpotlight, closeWindow, createFolder, getNodeByPath, startEditingIcon, deleteNode, setClipboard, pasteClipboard, selectedIcons]);
